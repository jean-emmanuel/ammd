    ...
    $("#partageur_source li a").click(function(){                
               if ($(this).attr("rel") !="-1") {
                    ...
                    if (ref.substr(0,3) == "art") {
                        ref = ref.substr(3);
                        var id_rub = $("#partageur_source").attr("rel");                        
                        var import_url = "?exec=partageur_import&id_partageur="+id_url_site_partage+"&id_article="+ref+"&id_rubrique="+id_rub+"&cle="+cle_url_site_partage;                        
                        location.href = import_url; 
