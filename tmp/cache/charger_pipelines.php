...
if (!$inc){
include_once_check(_ROOT_PLUGINS_DIST.'sites/sites_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/partageur_3/partageur_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/breves_pipelines.php');
$inc=true;
}
$val = minipipe('sites_affiche_enfants', $val);
$val = minipipe('partageur_affiche_enfants', $val);
...
include_once_check(_ROOT_PLUGINS.'auto/saisies/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/champs_extras3/cextras_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/champs_extras3_interface/inc/iextras.php');
$inc=true;
}
...
$val = minipipe('iextras_formulaire_verifier', $val);
return $val;
}
...
$val = minipipe('partageur_insert_head_prive_css', $val);
return $val;
}
...
if (!$inc){
include_once_check(_ROOT_RESTREINT.'/inc/pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/facteur/facteur_pipelines.php');
$inc=true;
}
$val = minipipe('f_recuperer_fond', $val);
$val = minipipe('facteur_recuperer_fond', $val);
return $val;
}
// Pipeline traduire 
...
$val = minipipe('saisies_saisies_autonomes', $val);
return $val;
}
...
$val = minipipe('saisies_formulaire_saisies', $val);
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/champs_extras3_interface/base/iextras.php');
$inc=true;
}
