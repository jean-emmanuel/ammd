...
'</li>
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_st @ ../prive/squelettes/contenu/auteurs.html","profiler");
	return $t0;
}

//
// Fonction principale du squelette ../prive/squelettes/contenu/auteurs.html
// Temps de compilation total: 4.530 ms
//
...
' .
vide($Pile['vars'][$_zzz=(string)'statuts'] = auteurs_lister_statuts('redacteurs')) .
