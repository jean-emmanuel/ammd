 ...
 * Date :      Fri, 04 Oct 2013 08:12:00 GMT
...
function BOUCLE_soushtml_2a5d394fc472a60fc393c48c958070bb(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_sous @ ../prive/squelettes/inclure/barre-nav.html","profiler");
	return $t0;
}
...
table_valeur($Pile["vars"], (string)'li', null));
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_boutons @ ../prive/squelettes/inclure/barre-nav.html","profiler");
	return $t0;
}
...
function BOUCLE_creersoushtml_2a5d394fc472a60fc393c48c958070bb(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_creersous @ ../prive/squelettes/inclure/barre-nav.html","profiler");
	return $t0;
}
...
function BOUCLE_creerhtml_2a5d394fc472a60fc393c48c958070bb(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_creer @ ../prive/squelettes/inclure/barre-nav.html","profiler");
	return $t0;
}
...
function BOUCLE_collaborersoushtml_2a5d394fc472a60fc393c48c958070bb(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_collaborersous @ ../prive/squelettes/inclure/barre-nav.html","profiler");
	return $t0;
}
...
function BOUCLE_collaborerhtml_2a5d394fc472a60fc393c48c958070bb(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_collaborer @ ../prive/squelettes/inclure/barre-nav.html","profiler");
	return $t0;
}

//
// Fonction principale du squelette ../prive/squelettes/inclure/barre-nav.html
// Temps de compilation total: 160.010 ms
//
