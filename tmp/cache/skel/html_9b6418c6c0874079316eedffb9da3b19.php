...
function html_9b6418c6c0874079316eedffb9da3b19($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
(($t1 = strval((((((table_valeur(@$Pile[0], (string)'url', null)) ?'' :' ')) OR (match(table_valeur(@$Pile[0], (string)'url', null),(	'^/?(.*/)?' .
	...
	array('prive/login.html','html_9b6418c6c0874079316eedffb9da3b19','',31,$GLOBALS['spip_lang'])) .
	'
	')) :
		'') .
'
...
executer_balise_dynamique('FORMULAIRE_LOGIN',
	...
	array('prive/login.html','html_9b6418c6c0874079316eedffb9da3b19','',14,$GLOBALS['spip_lang'])) .
'
	<p class="retour">
		' .
...
'
	...
	return analyse_resultat_skel('html_9b6418c6c0874079316eedffb9da3b19', $Cache, $page, 'prive/login.html');
}
?>