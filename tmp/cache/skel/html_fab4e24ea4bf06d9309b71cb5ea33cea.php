 ...
 * Date :      Fri, 04 Oct 2013 08:08:47 GMT
...
');
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_article_en_redaction @ ../plugins-dist/compagnon/compagnon/article_redaction.html","profiler");
	return $t0;
}

//
// Fonction principale du squelette ../plugins-dist/compagnon/compagnon/article_redaction.html
// Temps de compilation total: 23.002 ms
//
