...
'
' .
vide($Pile['vars'][$_zzz=(string)'saisies'] = interdire_scripts(saisies_verifier_afficher_si(entites_html(table_valeur(@$Pile[0], (string)'saisies', null),true),unserialize(@serialize($Pile[0]))))) .
'
' .
