 ...
 * Compile :   Fri, 04 Oct 2013 12:31:41 GMT
 * Boucles :   _objets
 */ 
...
');
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_objets @ ../prive/themes/spip/picker.css.html","profiler");
	return $t0;
}

//
// Fonction principale du squelette ../prive/themes/spip/picker.css.html
// Temps de compilation total: 154.009 ms
//
