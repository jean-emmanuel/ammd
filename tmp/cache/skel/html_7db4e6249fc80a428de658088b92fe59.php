 ...
 * Compile :   Fri, 04 Oct 2013 12:31:38 GMT
...
');
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_css @ ../prive/themes/spip/style_prive.css.html","profiler");
	return $t0;
}
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_cssplugins @ ../prive/themes/spip/style_prive.css.html","profiler");
	return $t0;
}

//
// Fonction principale du squelette ../prive/themes/spip/style_prive.css.html
// Temps de compilation total: 186.011 ms
//
