...
'</a></li>
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_admins @ ../prive/objets/infos/rubrique.html","profiler");
	return $t0;
}
...
quete_condition_postdates('articles.date',''), 
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_arts @ ../prive/objets/infos/rubrique.html","profiler");
	return $t0;
}
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_rubs @ ../prive/objets/infos/rubrique.html","profiler");
	return $t0;
}
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_publie @ ../prive/objets/infos/rubrique.html","profiler");
	return $t0;
}
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_rub @ ../prive/objets/infos/rubrique.html","profiler");
	return $t0;
}

//
// Fonction principale du squelette ../prive/objets/infos/rubrique.html
// Temps de compilation total: 174.010 ms
//
