 ...
 * Date :      Fri, 04 Oct 2013 08:11:56 GMT
 * Compile :   Fri, 04 Oct 2013 12:32:18 GMT
...
')) :
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_afficher_contenu @ ../prive/objets/contenu/article.html","profiler");
	return $t0;
}

//
// Fonction principale du squelette ../prive/objets/contenu/article.html
// Temps de compilation total: 91.005 ms
//
