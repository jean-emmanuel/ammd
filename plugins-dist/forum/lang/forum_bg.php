...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_enregistrement_obligatoire' => 'Задължителна регистрация (
  преди да можете да участвате, необходимо е да се абонирате като
  запишете електронния си адрес).',
